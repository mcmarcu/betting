...
namespace BettingTest
{
    public class GoalsDifferenceMetricTest
    {
        ...
        public void GetScoredGoals()
        {
            ...
            // Act
            double goalsScoredTeam1 = metric.GetScoredGoals(actualFixture, teamId1);
            double goalsScoredTeam2 = metric.GetScoredGoals(actualFixture, teamId2);
        ...
        public void GetConcededGoals()
        {
            ...
            // Act
            double goalsConcededTeam1 = metric.GetConcededGoals(actualFixture, teamId1);
            double goalsConcededTeam2 = metric.GetConcededGoals(actualFixture, teamId2);
